    ...
    <Layout>
        ...
        <div style={section}>
          <div style={{ maxWidth: "760px" }}>
            ...
            <h2 style={{ fontSize: "40px", marginTop: "12px", marginBottom: "12px", color: "#A67C00" }}>
              House extension services in London
            </h2>
          </div>
          ...
          >
            ...
            <div style={card}>
              ...
              <p style={{ color: "#57534e", lineHeight: "1.8" }}>
                Make better use of unused side space in London terraced and
      ...
      <section style={section}>
        <div style={{ maxWidth: "820px" }}>
          ...
          <p style={{ color: "#57534e", lineHeight: "1.8" }}>
            We work with a range of clients across London, including homeowners
      ...
      >
        <div style={section}>
          <div style={{ maxWidth: "800px" }}>
            ...
            <p style={{ color: "#57534e", lineHeight: "1.8" }}>
              Many house extensions in London involve planning permission,
      ...
      >
        <div style={section}>
          <div style={{ maxWidth: "760px" }}>
            ...
            <h2 style={{ fontSize: "40px", marginTop: "12px", marginBottom: "12px", color: "#A67C00" }}>
              Why clients choose Crafman Design and Build for house extensions in London
            </h2>
          </div>
          ...
          >
            ...
            <div style={card}>Practical experience with London properties</div>
      ...
      >
        <div style={section}>
          <div style={{ maxWidth: "820px" }}>
            ...
            <h2 style={{ fontSize: "40px", marginTop: "12px", marginBottom: "20px" }}>
              House extensions London FAQs
            </h2>
          </div>

          <div style={{ display: "grid", gap: "16px" }}>
            <div style={card}>
              <h3 style={{ marginTop: 0 }}>How much does a house extension in London cost?</h3>
              <p style={{ color: "#57534e", lineHeight: "1.8", marginBottom: 0 }}>
      ...
      <section id="contact" style={{ ...section, paddingBottom: "80px" }}>
        ...
        >
          <div style={{ maxWidth: "760px" }}>
            ...
            <h2 style={{ fontSize: "40px", marginTop: "12px", marginBottom: "12px" }}>
              Talk to us about your extension project in London
            </h2>
            <p style={{ color: "#57534e", lineHeight: "1.8" }}>
              If you are planning a house extension in London, contact Crafman
